...
def main():
    ...
    company = "Tesla"  # Example company
    market_research = MarketResearchSystem(company, api_key)
    ...
    try:
        ...
        # Save results
        with open(f"{company}_ai_use_cases.md", "w") as f:
            f.write(formatted_results)
        
        print(f"Analysis complete. Results saved to {company}_ai_use_cases.md")
